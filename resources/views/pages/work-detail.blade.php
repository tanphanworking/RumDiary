    ...
    <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
        <div class="max-w-3xl mx-auto">
            ...
            @if($slug == 'cheese-coffee')
                <h1 class="text-4xl font-extrabold text-gray-900">Cheese Coffee</h1>
                <p class="mt-2 text-xl text-gray-500">Industry: F&B</p>
                <div class="mt-8">
                    <h2 class="text-2xl font-bold text-gray-900">Challenges & Objectives</h2>
                ...
                <div class="mt-8">
                    <h2 class="text-2xl font-bold text-gray-900">Creative Storytelling & The Big Idea</h2>
                ...
                <div class="mt-8">
                    <h2 class="text-2xl font-bold text-gray-900">Outcome</h2>
                 ...
                 <div class="mt-8">
                    <h2 class="text-2xl font-bold text-gray-900">Client and Community Feedback</h2>
                    <blockquote class="mt-4">
                        <p class="text-lg text-gray-500">"The new visual identity is a game-changer for us. Rum Diary's team truly understood our vision."</p>
                        <footer class="mt-2 text-gray-500">- Client</footer>
                    </blockquote>
                </div>
            @elseif($slug == 'm-village')
                {{-- Content for M Village --}}
                <h1 class="text-4xl font-extrabold text-gray-900">M Village</h1>
                <p class="mt-2 text-xl text-gray-500">Industry: Lifestyle / Co-living</p>
            @else
                 {{-- Content for FEN Izakaya --}}
                 <h1 class="text-4xl font-extrabold text-gray-900">FEN Izakaya</h1>
                 <p class="mt-2 text-xl text-gray-500">Industry: F&B</p>
            @endif

            <div class="mt-12">
                <a href="/work" class="text-base font-semibold text-indigo-600 hover:text-indigo-500">Back to Our Work</a>
            </div>
        </div>
    </div>
</div>
